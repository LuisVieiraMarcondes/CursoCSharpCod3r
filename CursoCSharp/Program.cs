...
/*O exemplo de Central de exercicios foi criado uma nova instancia de CentraldeExercicio com
 * o parametro de dicionário, assim criamos um dicionário de chave e valor Com uma string e 
 * uma Action (que tem funçao void), e no final dos exercicios , chamamos central.SelecionarEExecutar();
 * */
    ...
    class Program
    {
        static void Main(string[] args)
        {
            var central = new CentralDeExercicios(new Dictionary<string, Action>() {
                ...
                {"Váriaveis e Constantes - Fundamentos", Variaveis_Constantes.Executar},
                ...
                { "Props - Classes e Métodos", Propriedades.Executar},
                { "Readonly - Classes e Métodos", ReadOnly.Executar},
                { "Enum - Classes e Métodos", ExemploEnum.Executar},
                { "Struct - Classes e Métodos", ExemploStruct.Executar},
                { "Struct Vs Classe - Classes e Métodos", StructVsClass.Executar},
                { "Valor Vs Referência - Classes e Métodos", ValorVsRefencia.Executar},
